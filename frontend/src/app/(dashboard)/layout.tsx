      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative bg-cream">
        ...
        <div className="absolute top-6 right-6 z-50 flex items-center gap-4">
          <button className="relative text-near-black/60 hover:text-near-black transition-colors">
            <Bell size={20} />
            <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-[#EDD9A3] text-near-black text-[12px] font-bold">
              3
            </span>
          </button>
          <div className="h-8 w-8 rounded-full bg-[#E2DDD6] border border-[#d6cfc4] flex items-center justify-center text-near-black font-semibold text-[17px]">
            {user.name.charAt(0)}
          </div>
        </div>
